        ...
        <Card
          ...
          description={
            <>
              ...
              information. Each DMSP satellite has a 101 minute, sun-synchronous near-polar orbit at an altitude of 830
              km above the surface of the earth, and provides global coverage twice per day. The visible and infrared
              sensors (OLS) was originally designed to capture the faint moonlight reflected by night-time clouds, in
              order to obtain information on the distribution of night-time clouds. However, scientists unexpectedly
              discovered that DMSP/OLS can capture the luminescence of night-time towns and other areas in the absence
              of clouds. The National Oceanic and Atmospheric Administration (NOAA) released the annual synthetic stable
        ...
        <Card
          ...
          description={
            <>
              ...
              Normalized Difference Vegetation Index (NDVI) composite and DMSP/OLS Night Time Light (NTL) to
              characterize global urban areas at a 30 m resolution, and it can greatly enhance urban areas, which can
              then be easily distinguished from bare lands including fallows and deserts. With the capability to
              delineate urban boundaries and, at the same time, to present sufficient spatial details within urban
              areas, the NDUI has the potential for urbanization studies at regional and global scales, which was
              proposed by Professor Qingling Zhang from Sun Yat-sen University.
            </>
          }
          cover={
            <div>
        ...
        <Card
          ...
          description={
            <>
              ...
              daytime hyperspectral imagery (32 spectral bands), night-time light imagery (8 spectral bands) and
              infrared imagery. QMX-1 can obtain high-resolution night-time light images, with a spatial resolution of
              up to 21 m and a swath of approximately 107 km. The revisit period of QMX-1 is about 11 days, and the
              night-time transit time is 22:30 local time. As the first visible-light hyperspectral and night-light
              multispectral on-orbit programmable remote sensing satellite in China, the design life of QMX-1 is one
              year. After task scheduling, instruction annotation, data reception, data decoding, radiometric correction
              and geometric correction, satellite research and development team successfully obtained remote sensing
              image products.
            </>
          }
          cover={
        ...
        <Card
          ...
          description={
            <>
              ...
              satellite of the Chinese Academy of Sciences, which is launched successfully into orbit on 5 November
              2021. Tailored to the needs of monitoring and evaluating indicators related to global SDGs, SDGSAT-1 is
              equipped with three optical imagers, among which the low-light-level imager, Glimmer Imager for
              Urbanization (GIU), can obtain the night-time light images. SDGSAT-1 flies in a sun-synchronous orbit at
              an altitude of 505 km and inclination angle of 97.5°, resulting in a spatial resolution of 10 m for the
              GIU, which allows SDGSAT-1 to cover the globe in eleven days.
            </>
          }
          cover={
            <>
        ...
        <Card
          ...
          description={
            <>
              ...
              Yangwang-1 uses visible and ultraviolet observations to detect near-Earth asteroids and perform
              astronomical observation, asteroid observation, and space debris observation etc.. At the same time, it
              has both night-time remote sensing monitoring capabilities by tuning its camera to target the ground. The
              spatial resolution of the night-time light satellite images obtained has reached less than 30 meters,
              which provides compelling night-time remote sensing data for worldwide demand.
            </>
          }
          cover={
            <div>
