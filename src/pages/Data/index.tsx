  ...
  <div>
    <Row gutter={[16, 16]}>
      <Col xs={16} lg={16} xl={16}>
        <Card title='NOAA DMSP/OLS Product' className={styles.welcome} bordered={false}>
          <p>
            ...
            above the surface of the earth, and provides global coverage twice per day. The visible and infrared sensors
            (OLS) was originally designed to capture the faint moonlight reflected by night-time clouds, in order to
            obtain information on the distribution of night-time clouds. However, scientists unexpectedly discovered
            that DMSP/OLS can capture the luminescence of night-time towns and other areas in the absence of clouds. The
            National Oceanic and Atmospheric Administration (NOAA) released the annual synthetic stable night-time light
            data from 1992 to 2013 with a 30 arc-second spatial resolution, which is still one of the most widely used
            night light remote sensing data.
          </p>
          <div>
            <Image
              alt=''
            ...
            />
            <div style={{ textAlign: 'center' }}>DMSP/OLS night-time light image of Mexico city</div>
          </div>
          <span>
        ...
        >
          <p>
            ...
            distinguished from bare lands including fallows and deserts. With the capability to delineate urban
            boundaries and, at the same time, to present sufficient spatial details within urban areas, the NDUI has the
            potential for urbanization studies at regional and global scales, which was proposed by Professor Qingling
            Zhang from Sun Yat-sen University.
          </p>
          <div>
            <Image
              alt=''
              src={image2}
              fit='contain'
              style={{ width: '450px', height: '380px', backgroundColor: '#fff', margin: '0 auto' }}
            />
            <div style={{ textAlign: 'center' }}>Normalized difference urban index composite display</div>
          </div>
          <span>
            Download: <Link theme='primary'>https://www.scidb.cn/en/cstr/31253.11.sciencedb.01625</Link>
          </span>
        </Card>
        <Card title='NASA Black Marble Product' className={styles.welcome} bordered={false}>
          <p>
            The Day/Night Band (DNB) sensor of the Visible Infrared Imaging Radiometer Suite (VIIRS), on-board the
            Suomi-National Polar-orbiting Partnership (S-NPP), provides global daily measurements of nocturnal visible
            and near-infrared (NIR) light that are suitable for Earth system science and applications studies. To
            ...
            daily moonlight-adjusted night-time lights product (VNP46A2), the monthly moonlight-adjusted night-time
          ...
          <div>
            ...
            />
            <div style={{ textAlign: 'center' }}>Subset of black marble 2016 annual composite generated</div>
          </div>
          <span>
            Product Homepage:{' '}
        ...
        <Card title='Qimingxing-1 Night-time Light Datasets' className={styles.welcome} bordered={false}>
          <p>
            Qimingxing-1 (QMX-1), launched on 27 February 2022, is the first student-centered satellite developed by
            Wuhan University, equipped with visible light camera and infrared camera, making it possible to obtain
            daytime hyperspectral imagery (32 spectral bands), night-time light imagery (8 spectral bands) and infrared
            imagery. QMX-1 can obtain high-resolution night-time light images, with a spatial resolution of up to 21 m
            and a swath of approximately 107 km. The revisit period of QMX-1 is about 11 days, and the night-time
          ...
          <div style={{ textAlign: 'center' }}>QMX-1 night-time light images of Washington D.C. and Athens</div>
          <span>
        ...
        <Card title='SDGSAT-1 Satellite’s Glimmer Imager Product' className={styles.welcome} bordered={false}>
          <p>
            ...
            Tailored to the needs of monitoring and evaluating indicators related to global SDGs, SDGSAT-1 is equipped
            with three optical imagers, among which the low-light-level imager, Glimmer Imager for Urbanization (GIU),
            can obtain the night-time light images. SDGSAT-1 flies in a sun-synchronous orbit at an altitude of 505 km
            and inclination angle of 97.5°, resulting in a spatial resolution of 10 m for the GIU, which allows SDGSAT-1
            to cover the globe in eleven days.
          </p>
          <Row justify='center'>
            <Col>
              <Image
                ...
                src={image6}
                fit='contain'
                style={{ width: '380px', height: '240px', backgroundColor: '#fff', margin: '0 auto' }}
              />
            </Col>
            <Col>
              <Image
          ...
          <div style={{ textAlign: 'center' }}>
            SDGSAT-1 Night-time light images of Algiers（left: panchromatic band image; right: multispectral image）
          </div>
          <span>
        ...
        <Card title='Yangwang-1 Night-time Light Product' className={styles.welcome} bordered={false}>
          <p>
            Launched successfully in June 2021, Yangwang-1 (“Look Up 1”) is China's first visible/UV light space
            telescope, and is currently the only large-field ultraviolet space probe in orbit around the world.
            Yangwang-1 uses visible and ultraviolet observations to detect near-Earth asteroids and perform astronomical
            observation, asteroid observation, and space debris observation etc.. At the same time, it has both
            night-time remote sensing monitoring capabilities by tuning its camera to target the ground. The spatial
            resolution of the night-time light satellite images obtained has reached less than 30 meters, which provides
            compelling night-time remote sensing data for worldwide demand.
          </p>
          <div>
            <Image
              alt=''
            ...
            />
            <div style={{ textAlign: 'center' }}>Yangwang-1 night-time light image of United Arab Emirates</div>
          </div>
          <span>
