...
const Background: React.FC<BrowserRouterProps> = () => (
  <div>
    <Card className={styles.welcome} bordered={false}>
      <Row justify='space-between'>
        <Col className={styles.name}>
          <p>
            Night-time light remote sensing utilizes remote sensing techniques to observe and analyze artificial lights
          ...
          <p>
            The availability of satellites equipped with specialized sensors capable of detecting low-light emissions
            emissions has revolutionized the way people view the earth. These sensors capture data on the intensity,
          ...
          <p>
            ...
            monitoring changes in these lights over time, people can track the growth of urban areas, identify patterns
          ...
          <p>
            Night-time light remote sensing also plays a significant role in monitoring economic activity. The intensity
            intensity of night-time lights often correlates with economic indicators such as gross domestic product
          ...
          <p>
            ...
            outages during natural disasters and monitoring post-disaster recovery efforts. It contributes to public
            public health studies by analyzing the relationship between night-time lights and the prevalence of certain
          ...
          <p>
            In conclusion, night-time light provides valuable insights into urbanization dynamics, economic activity,
            activity, environmental changes, and various socio-economic factors. As technology continues to advance,
            advance, night-time light remote sensing is expected to play an increasingly vital role in understanding and
            managing our ever-changing world.
          </p>
        </Col>
      </Row>
    </Card>
